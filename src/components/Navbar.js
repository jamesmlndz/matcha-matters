  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        {/* Center Logo */}
        <div className="text-2xl font-extrabold tracking-wide text-center flex-1 md:absolute md:left-1/2 md:transform md:-translate-x-1/2">
          <Link
            to="/home"
      ...
      {isOpen && (
        <div
          ...
          } backdrop-blur-md px-6 py-6`}
        >
          <ul className="flex flex-col gap-4 text-lg font-medium text-center">
